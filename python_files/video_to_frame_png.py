...
#-----------SETUP VARIABLES:-----------
image_type = ".png"
video_name = "vid_shorter.mp4" #should be changed to be the argument with which the script is called
input_folder = "../videos" #should be changed to "Input_content" later on
output_folder = "./../frames/vid_shorter_frames_png"
